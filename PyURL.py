...
app_title=Label(root,text="PyURLShortner",font=("forte",40,"bold"),bg=color((22,22,22)),fg="aqua").pack()
app_sub_heading=Label(root,text="An Easy To Use URL Shortner",font=("berlin sans fb demi",12,"bold"),bg=color((22,22,22)),fg="aqua").pack()
